...
export default function UpdatePasswordForm({ className = '' }) {
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="text-lg font-medium dark:text-green-500 dark:hover:text-green-800 text-green-800 hover:text-green-500">Atualizar senha</h2>

                <p className="mt-1 text-sm dark:text-green-500 dark:hover:text-green-800 text-green-800 hover:text-green-500">
